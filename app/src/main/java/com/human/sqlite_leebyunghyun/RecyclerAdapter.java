package com.human.sqlite_leebyunghyun;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ItemViewHolder> {
    //android에서 제공되는 OnItemClick리스너는 매겨변수 4개 이기 때문에 2개짜리로 추가
    public interface OnItemClickListener {//중첩클래스내에서 사용
    ...
    //인터페이스 온클릭리스너에 대한 셋메서드생성(나중에 메인액티비티에서 사용예정,)
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        //inflate()매개변수 xml이 디자인.리사이클러뷰 내에 들어가는 아이템디자인 생성
    ...
    //뷰홀더와 포지션 pos를 이용해서 xml디자인textView item에 기존값 출력하기
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(@NonNull View itemView) {//new 생성자 메서드
            ...
            //new키워드로 생성(객체가만들어질)될때 아이템 클릭 이벤트 생성.
